**[Offset Pagination - Trigger `SELECT COUNT` Subquery And Return `List<dto>`](https://github.com/andreipall/Spring-Boot-JPA/tree/master/HibernateSpringBootListDtoOffsetPagination)**
