**[How To Implement Concurrent Table Based Queue Via `SKIP_LOCKED` In MySQL 8](https://github.com/andreipall/Spring-Boot-JPA/tree/master/HibernateSpringBootMySqlSkipLocked)**
